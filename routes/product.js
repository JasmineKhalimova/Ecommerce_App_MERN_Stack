...
router.put("/product/:productId/:userId", requireSignin, isAuth, isAdmin, update);//UPDATE
router.delete("/product/:productId/:userId",requireSignin, isAuth, isAdmin, remove);// DELETE
